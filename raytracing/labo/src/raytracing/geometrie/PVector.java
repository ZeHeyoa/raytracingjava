...
public class PVector implements Serializable {
  ...
  public PVector lerp(PVector v, float amt) {
    x = Sampling.lerp(x, v.x, amt);
    y = Sampling.lerp(y, v.y, amt);
    z = Sampling.lerp(z, v.z, amt);
    return this;
  }
  ...
  public PVector lerp(float x, float y, float z, float amt) {
    this.x = Sampling.lerp(this.x, x, amt);
    this.y = Sampling.lerp(this.y, y, amt);
    this.z = Sampling.lerp(this.z, z, amt);
    return this;
  }
